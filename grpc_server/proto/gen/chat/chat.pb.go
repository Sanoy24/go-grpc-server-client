...
const file_proto_chat_proto_rawDesc = "" +
	...
	"\vChatService\x12(\n" +
	"\bSayHello\x12\r.chat.Message\x1a\r.chat.Message\x12,\n" +
	"\n" +
	"ChatStream\x12\r.chat.Message\x1a\r.chat.Message0\x01\x12,\n" +
	"\n" +
	"SendStream\x12\r.chat.Message\x1a\r.chat.Message(\x01\x12,\n" +
	"\bFullChat\x12\r.chat.Message\x1a\r.chat.Message(\x010\x01B\x19Z\x17/proto/gen/chat;chatapib\x06proto3"
...
var file_proto_chat_proto_depIdxs = []int32{
	...
	0, // 2: chat.ChatService.SendStream:input_type -> chat.Message
	0, // 3: chat.ChatService.FullChat:input_type -> chat.Message
	0, // 4: chat.ChatService.SayHello:output_type -> chat.Message
	0, // 5: chat.ChatService.ChatStream:output_type -> chat.Message
	0, // 6: chat.ChatService.SendStream:output_type -> chat.Message
	0, // 7: chat.ChatService.FullChat:output_type -> chat.Message
